...
' para Diretoria, Gerência e Corretor.
' ====================================================================
...
Dim idVenda, dataPagamento, statusPagamento, obsPagamento
...
obsPagamento = "Pagamento automático."
...
' Função para inserir pagamento (sem a divisão /100 suspeita)
Function InserirPagamento(connSales, userId, idVenda, nomeUsuario, valor, dataPagamento, statusPagamento, obsPagamento, tipoRecebedor, tipoPagamento)
...
If IsNumeric(idVenda) And idVenda <> "" Then
    ...
    Else
        ...
        valorVenda = FormatCurrency(rsVenda("ValorVenda"))
        ...
        If saldoDiretoriaC > 0 And IsNumeric(userIdDiretoria) Then
            ...
            If InserirPagamento(connSales, userIdDiretoria, idVenda, nomeDiretor, saldoDiretoriaC, dataPagamento, statusPagamento, obsPagamento, "diretoria", "Comissão") Then
        ...
        If saldoDiretoriaP > 0 And IsNumeric(userIdDiretoria) Then
            If InserirPagamento(connSales, userIdDiretoria, idVenda, nomeDiretor, saldoDiretoriaP, dataPagamento, statusPagamento, obsPagamento, "diretoria", "Premiação") Then
                pagamentosRealizados = pagamentosRealizados + 1
            End If
        End If
        ...
        If saldoGerenciaC > 0 And IsNumeric(userIdGerencia) Then
            ...
            If InserirPagamento(connSales, userIdGerencia, idVenda, nomeGerente, saldoGerenciaC, dataPagamento, statusPagamento, obsPagamento, "gerencia", "Comissão") Then
                pagamentosRealizados = pagamentosRealizados + 1
            End If
        End If
        ...
        If saldoGerenciaP > 0 And IsNumeric(userIdGerencia) Then
            If InserirPagamento(connSales, userIdGerencia, idVenda, nomeGerente, saldoGerenciaP, dataPagamento, statusPagamento, obsPagamento, "gerencia", "Premiação") Then
                pagamentosRealizados = pagamentosRealizados + 1
            End If
        End If
        ...
        If saldoCorretorC > 0 And IsNumeric(userIdCorretor) Then
            ...
            If InserirPagamento(connSales, userIdCorretor, idVenda, nomeCorretor, saldoCorretorC, dataPagamento, statusPagamento, obsPagamento, "corretor", "Comissão") Then
                pagamentosRealizados = pagamentosRealizados + 1
            End If
        End If
        ...
        If saldoCorretorP > 0 And IsNumeric(userIdCorretor) Then
            If InserirPagamento(connSales, userIdCorretor, idVenda, nomeCorretor, saldoCorretorP, dataPagamento, statusPagamento, obsPagamento, "corretor", "Premiação") Then
                pagamentosRealizados = pagamentosRealizados + 1
            End If
        End If
        ...
        If Err.Number = 0 Then
            ...
            transacaoIniciada = False
            mensagemSucesso = "Sucesso! " & pagamentosRealizados & " pagamentos pendentes processados para a Venda " & idVenda & "."
        Else
...
<body>
    <div class="container">
        ...
        <form method="post" action="pagar_venda_completa.asp">
            <div class="form-group">
                <label for="ID_Venda">ID da Venda:</label>
                <input type="text" id="ID_Venda" name="ID_Venda" value="<%= idVenda %>" required placeholder="Ex: 1234">
        ...
        <% If IsNumeric(idVenda) And idVenda <> "" And mensagemErro = "" Then %>
            ...
            ' Re-executa a query da venda para garantir dados atualizados (se necessário)
            ...
            %>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><%= FormatCurrency(rsVendaDisplay("ValorVenda")) %></td>
                        <th>Data Venda</th>
            ...
            sqlPagamentos = "SELECT UsuariosNome, TipoRecebedor, TipoPagamento, ValorPago, DataPagamento, Status, Obs " & _
