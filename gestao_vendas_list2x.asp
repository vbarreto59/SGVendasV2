            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-end">
                    <div class="btn-group btn-group-responsive">
                        ...
                        <a href="gestao_vendas_create2.asp" class="btn btn-light btn-sm" target="_blank">
    ...
    <div class="container-fluid main-content">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-2">
                <div class="card stats-card">
                    ...
                    <div class="stats-value text-success">R$ <%= FormatNumber(totalValorHtml, 2) %></div>
                    <div class="stats-label">Valor em Vendas</div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="card stats-card">
                    ...
                    <div class="stats-value text-info">R$ <%= FormatNumber(totalComissaoHtml, 2) %></div>
                ...
                <div class="col-md-4 text-end">
                    <div class="btn-group">
                        <a href="gestao_vendas_gerenc_comissoes.asp" class="btn btn-primary btn-sm" target="_blank">
                            <i class="fas fa-money-bill-wave me-1"></i>Comissões
                        </a>
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                ...
                <!-- Conteúdo Mobile (mantido igual) -->
                <div class="mobile-cards p-3" id="mobileCardsContainer">
                    <!-- ... conteúdo mobile existente ... -->
                </div>
            </div>
        </div>
    </div>
