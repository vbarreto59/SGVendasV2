...
Dim kpiData, totalVGV, totalComissoes, totalComissoesDiretoria, totalComissoesGerencia, totalComissoesCorretor
...
If Not rs.EOF Then
    Do While Not rs.EOF
        ...
        If IsNull(rs("ComissaoVenda")) Then
            comissaoVenda = 0
        Else
...
<head>
    ...
    <title>SGVendas - Relatório de Comissões Completo</title>
...
<body>
    <div class="container-fluid">
        <h2 class="mt-4 mb-4 text-center" style="color: #800000;"><i class="fas fa-hand-holding-usd"></i> SGVendas - Relatório de Comissões Completo</h2>
